  ...
  return (
    <div className="section-padding">
      <div className="max-w-2xl mx-auto">
        <Link
          href="/blog"
          className="inline-flex items-center gap-1.5 text-xs font-mono text-ink-400 hover:text-accent transition-colors mb-10"
        >
        ...
        <h1 className="font-serif text-4xl font-medium text-ink-900 mb-4 leading-tight">
          {post.title}
        </h1>
