        ...
        <div className="container-max">
          ...
          <div className="space-y-6">
            {research.map((r, i) => (
              <article
                key={i}
                className="border border-ink-200 rounded-xl p-6 hover:border-accent/40 transition-colors"
              >
                <div className="flex flex-wrap items-start justify-between gap-3 mb-3">
                  <h3 className="font-serif text-lg font-medium text-ink-900 flex-1">
                    {r.title}
                  </h3>
                  <span
